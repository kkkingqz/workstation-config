...
set -l helpws_topics terminal term ghostty fish keyboard keys workstation system baseline touchbar rebuild roadmap plan-t2 plan-gnome plan-flatpak plan-dev plan-windows plan-virt plan-final man help
...
complete -c helpws -n '__fish_seen_subcommand_from man' -a 'ws-terminal ws-keyboard ws-workstation ws-touchbar ws-rebuild ws-roadmap ws-plan-t2 ws-plan-gnome ws-plan-flatpak ws-plan-dev ws-plan-windows ws-plan-virt ws-plan-final' -d 'Generated workstation man page'
